...
class UPerNetDecoder(nn.Module):
    def __init__(
        ...
        self.merge_channel = pyramid_channels if merge_policy == "add" else pyramid_channels * 4
        ...
        self.psp_last_conv = md.Conv2dReLU(
        ...
        self.conv_last = md.Conv2dReLU(self.merge_channel, self.out_channels, 1)
